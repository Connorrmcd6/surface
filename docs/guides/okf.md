...
That gap is exactly what Surface fills. The payoff lands hardest with agents, which read your docs
on every run: OKF makes the docs portable enough to reach every agent, Surface keeps them fresh
enough to trust, and portable-plus-fresh docs measurably improve how well those agents perform.
